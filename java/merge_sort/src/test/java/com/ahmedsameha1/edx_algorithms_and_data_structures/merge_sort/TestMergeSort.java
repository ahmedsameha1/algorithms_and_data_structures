...
public class TestMergeSort {
    ...
    public void test() {
        ...
        assertArrayEquals(new int[] {1, 2, 3, 4}, mergeSort.sort(new int[] { 4, 3, 2, 1}));
        assertArrayEquals(new int[] {-1, 1, 2, 3, 4}, mergeSort.sort(new int[] { 4, 3, 2, 1, -1}));
        assertArrayEquals(new int[] {-1, 15, 15, 52, 73, 104}, mergeSort.sort(new int[] { 15, 73, 104, 15, 52, -1}));
    }
}
